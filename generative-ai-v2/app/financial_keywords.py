...
FINANCIAL_KEYWORDS = [
    ...
    "hipotek", "tabungan", "jangka", "risiko", "operasional", "economic",
    "rekening", "sistem","pembayaran", "perbankan", "biaya transaksi", "perak",
    "komoditas", "derivatif", "keuangan pribadi", "keuangan korporasi", "spekulasi",
    "analisis", "fundamental", "analisis","teknis", "trading", "manajemen portofolio",
    ...
    "siklus ekonomi", "sistem perpajakan", "kebijakan keuangan", "pialang",
    "klaim", "uang tunai", "uang elektronik", "uang kertas", "logam",
    ...
    "digital currency", "fiat currency", "commodity", "derivative", "futures", "moneter",
    ...
    "fiscal policy", "economic policy", "regulation", "stability", "crisis", "kurs",
    "banking", "central", "commercial", "retail", "payment", "hiperinflasi",
    ...
    "advisor", "investment advisor", "stockbroker", "broker", "trader", "trade",
    ...
    "stability", "crisis", "credit crunch", "recession", "depression",
    ...
    "control", "decision", "policy", "governance", "leadership", "koin", "coint",
